 ...
 * @str: sending stringnokia_lcd_move_item(4);nokia_lcd_move_item(4);nokia_lcd_move_item(4);nokia_lcd_move_item(4);nokia_lcd_move_item(4);nokia_lcd_move_item(4);nokia_lcd_move_item(4);nokia_lcd_move_item(4);nokia_lcd_move_item(4);nokia_lcd_move_item(4);
 * @scale: size of text
 */
